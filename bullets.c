...
{
    if (poc->x > sta->x && poc->x < sta->x + 19 && poc->y > sta->y && poc->y < sta->y + 19 && sta->aktywny == 1) {
        sta->aktywny = 0;
        sta->licznik = 0;
        sta->k = 6;
